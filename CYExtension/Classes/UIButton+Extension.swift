...
//  CYBasic
//
//  Created by 刘铁崧 on 2019/7/2.
//  Copyright © 2019 com. CYBasic.demo. All rights reserved.
//

import UIKit

public extension UIButton {
    enum CYButtonEdgeInsetsStyle {
        case Top
        case Left
        case Right
        case Bottom
    ...
    func layoutButton(style: CYButtonEdgeInsetsStyle, imageTitleSpace: CGFloat){
